...
const UserListPage = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-4 bg-gray-800 rounded-lg shadow-xl">
      <h2 className="text-2xl font-bold mb-4 text-cyan-400">System User Report</h2>
      ...
      >
        {loading ? 'Generating...' : 'Generate System User Report'}
      </button>

      {users && (
        <div className="mt-4 border border-gray-700 p-4 rounded-lg">
          <p className="mb-2 text-sm text-gray-400">Report Output (Raw JSON):</p>
